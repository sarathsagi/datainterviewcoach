...
import { CheckCircle2, Circle, MinusCircle, ArrowLeft, Clock, Tag } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold">SQL Practice</h1>
          <p className="text-slate-400 mt-1 text-sm">
            42 problems spanning aggregation, window functions, CTEs, and warehouse-specific patterns.
          </p>
        </div>
          ...
          <section key={difficulty} className="space-y-2">
            ...
            <div className="space-y-2">
              {qs.map((q, i) => {
                ...
                return (
                  <Link key={q.id} href={`/practice/sql/${q.slug}`}>
